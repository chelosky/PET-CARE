package com.fillikenesucn.petcare.fragment;
...
import com.fillikenesucn.petcare.activity.UHFMainActivity;
import com.fillikenesucn.petcare.tools.StringUtils;
import com.fillikenesucn.petcare.tools.UIHelper;
//import com.fillikenesucn.petcare.fragment.KeyDwonFragment;
                ...
                if (popFilter == null) {
                    ...
                    btSet.setOnClickListener(new OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            if (len > 0) {
                                String rex = "[\\da-fA-F]*"; //Hacer coincidir expresiones regulares, datos en formato hexadecimal
...
//									mContext.playSound(2);
                    ...
                    cb_filter.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                        ...
                        public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                            if (isChecked) { //Habilitar filtrado


                            } else { //Deshabilitar filtrado
    ...
    public class BtImportClickListener implements OnClickListener {
        ...
        public void onClick(View v) {
            ...
            {
                UIHelper.ToastMessage(mContext, "Por favor, deje de escanear y luego exporte");
            }
        }
    ...
    public class RgInventoryCheckedListener implements OnCheckedChangeListener {
        ...
        public void onCheckedChanged(RadioGroup group, int checkedId) {
            ...
            if (checkedId == RbInventorySingle.getId()) {
                // Reconocimiento de un solo paso
                inventoryFlag = 0;
            } else if (checkedId == RbInventoryLoop.getId()) {
                // Reconocimiento de bucle de etiqueta única
                inventoryFlag = 1;
    ...
    private void readTag() {
        if (BtInventory.getText().equals(
                mContext.getString(R.string.btInventory)))// Etiqueta de identificación
        {
...
//					mContext.playSound(2);
                ...
                break;
                case 1:// Ciclo de etiqueta única  .startInventoryTag((byte) 0, (byte) 0))
                {
