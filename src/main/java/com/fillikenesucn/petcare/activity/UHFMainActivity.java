package com.fillikenesucn.petcare.activity;


import com.fillikenesucn.petcare.R;
import com.fillikenesucn.petcare.fragment.UHFKillFragment;
import com.fillikenesucn.petcare.fragment.UHFLockFragment;
import com.fillikenesucn.petcare.fragment.UHFReadFragment;
import com.fillikenesucn.petcare.fragment.UHFReadTagFragment;
import com.fillikenesucn.petcare.fragment.UHFSetFragment;
import com.fillikenesucn.petcare.fragment.UHFWriteFragment;
...
//			appContext = (AppContext) getApplication();
		...
		Log.d("SOUND INIT","EJECUTANDO");
		initSound();
		//SE ENCARGA DE INICIAR EL UHF DE LA PISTOLA
		Log.d("UHF INIT","EJECUTANDO");
		initUHF(); //��ʼ��
		Log.d("initViewPageData INIT","EJECUTANDO");
		//SOLO AÑADE LOS FRAGMENTOS Y NOMBRES DE LA VISTAS A LISTAS LIST<>
		initViewPageData();
		//SETEA LA VIEW CON EL PAGER
		initViewPager();
		//SETEA LOS TABS CON LAS FUNCIONALIDADES
		initTabs();
	...
	private void initSound(){
		...
		Log.d("SOUND INIT","COMPLETADO CON EXITO");
	}
	/**
	 * 播放提示音
	 *
