...
import com.fillikenesucn.petcare.adapter.ViewPagerAdapter;
import com.fillikenesucn.petcare.fragment.KeyDwonFragment;
import com.fillikenesucn.petcare.tools.UIHelper;
import com.fillikenesucn.petcare.widget.NoScrollViewPager;
...
//        mActionBar.addTab(mActionBar.newTab().setText(getString(R.string.myMenu)).setTabListener(mTabListener));
	...
	public class InitTask extends AsyncTask<String, Integer, Boolean> {
		...
		protected void onPostExecute(Boolean result) {
			...
			if (!result) {
				Toast.makeText(BaseTabFragmentActivity.this, "FALLO AL EMPEZAR",
